...
<div class="hint-container tip">
<p class="hint-container-title">Android 基础 ⭐⭐⭐⭐⭐</p>
<p>实现产品提出的业务需求、交互逻辑</p>
<ul>
<li>自定义 View、手势冲突处理</li>
<li>动画效果、性能优化</li>
<li>折叠屏、深色模式适配</li>
</ul>
</div>
<div class="hint-container tip">
<p class="hint-container-title">跨平台开发 ⭐⭐⭐⭐</p>
<p>点评自研跨平台框架 Picasso</p>
<ul>
<li>类RN框架，使用 TypeScript 开发</li>
...
<ul>
<li>点评 APP 首页 Feed 流模块 &amp; 整体首页框架</li>
<li>消息中心相关页面：私聊、群聊、消息首页、系统消息页面等</li>
</ul>
</li>
<li>
<p><strong>平台适配工作</strong></p>
<ul>
<li>折叠屏、深色模式、英文版适配</li>
<li>置灰模式、隐私合规等功能实现</li>
</ul>
</li>
</ul>
...
<li>Feed 模块创建</li>
<li>Feed 缓存加载</li>
<li>Feed 真实数据加载（含图片）</li>
</ol>
</li>
<li>通过 Feed 卡片 Native 化、接口预加载</li>
<li>提升子线程优先级、图片 Push 预热等手段</li>
...
<li><strong>团队协作</strong>：具备丰富的大型团队协作经验</li>
<li><strong>技术栈</strong>：Android、Kotlin、跨平台、前端、后端全栈能力</li>
</ul>
</div>
<hr>
</div></template>
